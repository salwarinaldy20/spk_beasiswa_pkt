		...
		<div class="d-flex flex-column flex-lg-row-fluid py-10">
			...
			<div class="d-flex flex-center flex-column flex-column-fluid">
				...
				<div class="w-lg-500px p-10 p-lg-15 mx-auto">
					...
					<form class="form w-100 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" id="form1" action="#">
						<!--begin::Heading-->
						...
						<div class="text-center mt-10">
							<!--begin::Submit button-->
							<button type="submit" id="btnlogin" class="btn btn-lg btn-warning w-100 mb-5">
