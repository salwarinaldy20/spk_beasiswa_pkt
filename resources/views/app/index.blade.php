...
<div class="page-title d-flex flex-column align-items-start me-3 py-2 py-lg-0 gap-2">
    <!--begin::Title-->
    <h1 class="d-flex text-white fw-bolder m-0 fs-3">Dashboard
    <!--begin::Separator-->
    <!--end::Description--></h1>
    <!--end::Title-->
</div>    
                                    ...
                                    <tbody>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <a href="../dist/account/overview.html"
                                                            ...
                                                            Simmons</a>
                                                        <span
                                                            class="text-gray-400 fw-bold d-block">HTML,
                                                            JS, ReactJS</span>
                                                    </div>
                                                </div>
                                            </td>
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px py-3"
                                                    ...
                                                    <div class="menu-item px-3"
                                                        ...
                                                        <a href="#" class="menu-link px-3">
                                                            <span
                                                                class="menu-title">Subscription</span>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <a href="../dist/account/overview.html"
                                                            ...
                                                            Clarcson</a>
                                                        <span
                                                            class="text-gray-400 fw-bold d-block">C#,
                                                            ASP.NET, MS SQL</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <a href="../dist/account/overview.html"
                                                            ...
                                                            Wayde</a>
                                                        <span
                                                            class="text-gray-400 fw-bold d-block">PHP,
                                                            Laravel, VueJS</span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100 me-2 mt-2">
                                                    <span
                                                        class="text-gray-400 me-2 fw-boldest mb-2">40%</span>
                                                    <div
                                                        class="progress bg-light-danger w-100 h-5px">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex flex-column w-100 me-2 mt-2">
                                                    <span
                                                        class="text-gray-400 me-2 fw-boldest mb-2">45%</span>
                                                    <div
                                                        class="progress bg-light-danger w-100 h-5px">
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-column px-9 pt-5">
                                        <!--begin::Number-->
                                        <div class="text-success fw-boldest fs-2hx">
                                            6.2k
                                        </div>
                                        <!--end::Number-->
                                        <!--begin::Description-->
                                        <span class="text-gray-400 fw-bold fs-6">Weekly New
                                            Followers</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Hidden-->
                                    <!--begin::Chart-->
                                    <div class="statistics-widget-1-chart card-rounded-bottom"
                            ...
                            <div class="card card-xxl-stretch-50 mb-xxl-8">
                                ...
                                <div class="card-body pt-5">
                                    <!--begin::Chart-->
                                    <div id="kt_mixed_widget_1_chart" data-kt-height="250"
                                        class="mb-n15"></div>
                                    <!--end::Chart-->
                                    <!--begin::Label-->
                                    <span
                                        ...
                                        <i
                                            class="fas fa-exclamation-circle text-warning me-3 fs-3"></i>Only
                                        New Users</span>
                                    <!--end::Label-->
                                </div>
                                <!--end::Body-->
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="card card-xxl-stretch-50 mb-5 mb-xl-8">
                                ...
                                <div
                                    ...
                                    <div class="d-flex flex-column px-9 pt-5">
                                        ...
                                        <!--end::Number-->
                                        <!--begin::Description-->
                                        <span class="text-gray-400 fw-bold fs-6">My Weekly
                                            Targets</span>
                                        <!--end::Description-->
                                    </div>
                                    <!--end::Hidden-->
                                    <!--begin::Chart-->
                                    <div id="kt_mixed_widget_2_chart" class="mx-3"
                                        data-kt-color="primary" style="height: 175px"></div>
                                    <!--end::Chart-->
                                </div>
                            </div>
                            <!--end::Mixed Widget 2-->
                            ...
                            <div class="card card-xxl-stretch-50" style="background-color: #1c53e1">
                                ...
                                <div class="card-body d-flex align-items-end p-0 pt-10">
                                    ...
                                    <div class="flex-grow-1 ps-9 pb-9">
                                        ...
                                        <div class="pt-8">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <span
                                                    class="svg-icon svg-icon-3 svg-icon-white me-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <!--end::Svg Icon-->
                                                <span
                                                    class="fw-bolder fs-7 text-white">Cereate</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="d-flex align-items-center mb-3">
                                                ...
                                                <!--end::Svg Icon-->
                                                <span
                                                    class="fw-bolder fs-7 text-white">Observe</span>
                                            </div>
                                            <!--end::Item-->
                                            <!--begin::Item-->
                                            <div class="d-flex align-items-center mb-5">
                                                ...
                                                <!--end::Svg Icon-->
                                                <span class="fw-bolder fs-7 text-white">Export
                                                    PDF</span>
                                            </div>
                                            <!--end::Item-->
                                        </div>
                                    ...
                                    <!--end::Wrapper-->
                                    <img class="mh-200px" alt=""
                                        src="assets/media/svg/illustrations/engage.svg" />
                                </div>
                                <!--end::Card body-->
                            </div>
                            <!--end::Engage widget 1-->
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-5">
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-gray-400 mt-2 fw-bold fs-6">32 Active
                                    Folders</span>
                            </h3>
                            <div class="card-toolbar">
                                <!--begin::Menu-->
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="d-flex flex-stack item-border-hover px-3 py-2 ms-n4 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1 mb-1">
                                        <a href="#"
                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Project
                                            Alice</a>
                            ...
                            <div class="d-flex flex-stack item-border-hover px-3 py-2 ms-n4 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1 mb-1">
                                        <a href="#"
                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">HR
                                            Confidential</a>
                                        <div class="text-gray-400 fw-bold">
                            ...
                            <div class="d-flex flex-stack item-border-hover px-3 py-2 ms-n4 mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1 mb-1">
                                        <a href="#"
                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Banner
                                            Assets</a>
                                        <div class="text-gray-400 fw-bold">
                                ...
                                <!--end::Section-->
                                <!--begin::Label-->
                                <span class="badge badge-light rounded-pill fs-7 fw-boldest">16
                                    files</span>
                                <!--end::Label-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div class="d-flex flex-stack item-border-hover px-3 py-2 ms-n4 mb-6">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-1 mb-1">
                                        <a href="#"
                                            class="fs-5 text-gray-800 text-hover-primary fw-boldest">Icon
                                            Assets</a>
                                        <div class="text-gray-400 fw-bold">
                                ...
                                <!--end::Section-->
                                <!--begin::Label-->
                                <span class="badge badge-light rounded-pill fs-7 fw-boldest">64
                                    files</span>
                                <!--end::Label-->
                            </div>
                            <!--end::Item-->
                            ...
                            <div
                                ...
                                <a href="#" class="link-primary fw-bolder fs-6 me-1">Intive New .NET
                                    Collaborators</a>
                                <span class="text-gray-800 fw-bold fs-6">to creating great
                                    outstanding business to
                                    business .jsp modular class outstanding
                                    scripts</span>
                            </div>
                            <!--end::Alert-->
                        </div>
