...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title flex-column">
            <h2 class="mb-1">List Kategori</h2>
    ...
    <div class="card-body py-4">
        ...
        <div>
            @if (Omjin::permission('kategoriCreate'))
            ...
            @endif
            <button type="button" class="btn btn-md btn-outline btn-outline-warning  btn-active-light-warning  me-2 hidex refresh"  data-refreshx="tblkategori"><i class="fa fa-sync-alt text-warning"></i></button>
        </div>
        {{-- 7771235312V451 --}}
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="dataxtbl" role="tabpanel">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-bordered display nowrap" id="tblkategori" style="width:100%">
                        <thead>
                            <tr>
                                <th style="align-items: center; width: 5px !important;">#</th>
                                <th width="1px">No</th>
                                <th width="70px">Kode Kategori</th>
                        ...
                        <thead>
                            <tr>
                                <td class="p-1" style="align-items: center; width: 5px !important;"><input type="checkbox" class="ckbsa" id="satblkategori"/></td>
                                <td class="p-1"></td>
                                <td class="p-1">
                                    <div class="input-group">
                                        ...
                                        <input  id="flkode_kategori" type="text" data-column="3" class="form-control py-0 fltable" placeholder="">
                                    </div>
                                </td>
                                <td class="p-1">
                                    <div class="input-group">
                                        ...
                                        <input  id="flkategori" type="text" data-column="3" class="form-control py-0 fltable" placeholder="">
                                    </div>
                                </td>
            ...
            <div class="tab-pane fade" id="formx" role="tabpanel">
                ...
                <form id="reg" novalidate="novalidate">
                    <div class="form-group row fv-row mb-5">
                        <label for="example-text-input" class="col-md-2 col-form-label">Kode Kategori</label>
                        <div class="col-md-10">
                            <input class="form-control form-control-solid" autocomplete="off" id="kode_kategori" name="kode_kategori" type="search"
                    ...
                    <div class="form-group row fv-row mb-5">
                        ...
                        <div class="col-md-10">
                            <input class="form-control form-control-solid" autocomplete="off" id="kategori" name="kategori" type="search"
