...
<div class="page-title d-flex flex-column me-3">
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-white opacity-75">Kriteria</li>
    </ul>
</div>
@endsection
...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title flex-column">
            <h2 class="mb-1">List Kriteria</h2>
    ...
    <div class="card-body py-4">
        ...
        <div>
            @if (Omjin::permission('kriteriaCreate'))
            ...
            @endif
            <button type="button" class="btn btn-md btn-outline btn-outline-warning  btn-active-light-warning  me-2 hidex refresh"  data-refreshx="tblkriteria"><i class="fa fa-sync-alt text-warning"></i></button>
        </div>
        {{-- 7771235312V451 --}}
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="dataxtbl" role="tabpanel">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-row-bordered display nowrap" id="tblkriteria" style="width:100%">
                        <thead>
                            <tr>
                                <th style="align-items: center; width: 5px !important;">#</th>
                                <th width="1px">No</th>
                                <th width="70px">Kode Kriteria</th>
                                <th width="70px">kriteria</th>
                        ...
                        <thead>
                            <tr>
                                <td class="p-1" style="align-items: center; width: 5px !important;"><input type="checkbox" class="ckbsa" id="satblkriteria"/></td>
                                <td class="p-1"></td>
                                <td class="p-1">
                                ...
                                <td class="p-1">
                                    <div class="input-group">
                                        ...
                                        <input  id="flkriteria" type="text" data-column="3" class="form-control py-0 fltable" placeholder="">
                                    </div>
                                </td>
            ...
            <div class="tab-pane fade" id="formx" role="tabpanel">
                ...
                <form id="reg" novalidate="novalidate">
                    <div class="form-group row fv-row mb-5">
                        ...
                        <div class="col-md-10">
                            <input class="form-control form-control-solid" autocomplete="off" id="kode_kriteria" name="kode_kriteria" type="search"
                    ...
                    <div class="form-group row fv-row mb-5">
                        ...
                        <div class="col-md-10">
                            <input class="form-control form-control-solid" autocomplete="off" id="kriteria" name="kriteria" type="search"
